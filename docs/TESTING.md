...
3. Fixture workflows: repository-state routing and safety behavior across 13
   representative repository shapes, including docs-only guidance, partial
   legacy guidance, and a role-equivalent custom Harness based on real-repository
   evidence.
